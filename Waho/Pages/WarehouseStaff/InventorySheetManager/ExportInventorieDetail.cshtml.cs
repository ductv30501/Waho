...
{
    public class ExportInventorieDetailModel : PageModel
    {
        ...
        public ExportInventorieDetailModel(DataServiceManager dataService, IWebHostEnvironment hostingEnvironment)
        {
            _dataService = dataService;
            _hostingEnvironment = hostingEnvironment;
        }
        public  IActionResult OnGetAsync(int inventorySheetID) {
            ...
            worksheet.Cells[3, 2].Value = inventorySheet.Date;
            ...
            worksheet.Cells[4, 2].Value = totalDifference;
